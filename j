...
public class prueb extends javax.swing.JFrame {
    ...
    public prueb() {
       ...
       private void inicializarTabla() {
        ...
        jlstHistorial.setModel(modeloLista);
    }
    ...
    private void agregarAHistorial(int numero) {
    ...
    private void initComponents() {
        ...
        jlstHistorial = new javax.swing.JList<>();
        ...
        jScrollPane2.setViewportView(jlstHistorial);
    ...
    private void jcbxComboActionPerformed(java.awt.event.ActionEvent evt) {                                          
        procesarSeleccion();
    }                                         
    ...
    private javax.swing.JList<String> jlstHistorial;
